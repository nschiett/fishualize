...
`fishualize` allows you to implement the colour pattern or your favourite fish for all you graphs.
...
The [**fishualize**](http:://github.com/nschiett/fishualize) package provides colour scales based on the natural colors of fishes.  
...
All credits for the initial structure of the functions for this package go to the `harrypotter` package made by Alejandro Jiménez: https://github.com/aljrico/harrypotter
